// Minimal alert bridge: sends email via a configured HTTP provider.
// Falls nichts konfiguriert ist, fällt es auf console.log zurück.
...
export async function sendAlert({ subject, text, to }: SendAlertOptions = {}) {
