...
const selectClass = "mt-1 w-full rounded-lg border border-input bg-background px-3 py-2 text-sm";
        ...
        {data.reports.length === 0 ? (
          ...
          data.reports.map((report) => (
            <article key={report.id} className="rounded-xl border border-border bg-card p-5">
              ...
              <form action={updateDamageStatusAction} className="mt-5 grid gap-4 rounded-lg border border-border bg-muted/40 p-4 sm:grid-cols-[1fr_auto]">
